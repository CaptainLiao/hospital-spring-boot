...
public class UserController {
  ...
  public ServerResponse<Token> register(String password, String username, HttpServletResponse response) {
    User user = new User();
  ...
  public ServerResponse<Token> register(@RequestBody User user) {
    return userService.register(user);
  }
}
